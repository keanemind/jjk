/*
This file was copied and modified from the vscode-winston-transport package.
*/
...
export class LogOutputChannelTransport extends Transport {
  ...
  public log(info: TransformableInfo, next: () => void) {
    ...
    switch (info[LEVEL]) {
      case "error":
        this.outputChannel.error(info[MESSAGE] as string);
        break;
      case "warning":
      case "warn":
        this.outputChannel.warn(info[MESSAGE] as string);
        break;
      case "info":
        this.outputChannel.info(info[MESSAGE] as string);
        break;
      case "debug":
        this.outputChannel.debug(info[MESSAGE] as string);
        break;
      case "trace":
        this.outputChannel.trace(info[MESSAGE] as string);
        break;
      default:
